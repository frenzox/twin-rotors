...
/**@brief Function for handle BLE write event.
 */
static void on_ble_data_receive(ble_rs_t* p_rs, ble_rs_evt_t* p_evt)
{
...
void services_init(void)
{
    ...
    ble_rs_init(&m_rs, &on_ble_data_receive);
}
...
static void ble_evt_dispatch(ble_evt_t * p_ble_evt)
{
    ...
    ble_rs_on_ble_evt(&m_rs, p_ble_evt);
}
